...
function obvodCtverce() {
	...
	if($cislo1 > 0) {
		...
		$vysledek = "Nejsou vyplněny požadované hodnoty";
	}
	return $vysledek;
}
...
function obsahTrojuhelniku(){
	...
	if (($cislo1 > 0 && $cislo4 > 0) || ($cislo2 > 0 && $cislo4 > 0) || ($cislo3 > 0 && $cislo4 > 0)) {
...
function Pythagorova() {
	...
	if ($cislo1 == 0 && $cislo2 < $cislo3) {
		...
		$vysledek = "<p class='count'>Strana a: " . $cislo1 . " " . $Jednotka . "<br/>Strana b: " . $cislo2 . " " . $Jednotka . "<br/>Strana c: " . $cislo3 . " " . $Jednotka ."</p>";
	} else {
...
function Jehlan() {
	...
	$vysledek = "<p class='count'>Obsah podstavy: " . $cislo3 . " " . $Jednotka . "<sup>2</sup><br/>Obsah pláště: " . $cislo4 . " " . $Jednotka . "<sup>2</sup><br/>Výška: " . $cislo5 . " " . $Jednotka . "<br/>Povrch: " . povrchJehlanu() . " " . $Jednotka . "<sup>2</sup><br/>Objem: " . objemJehlanu() .  " " . $Jednotka . "<sup>3</sup></p>";
