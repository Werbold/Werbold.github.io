...
function KinetickaEnergie(){
	...
	if ($cislo1 > 0 && $cislo2 > 0) {
		...
		$vysledek = "<p class='count'>v = " . $cislo1 . " m / s<br/>m = " . $cislo2 . " kg<br/>E<sub>p</sub> = " . $vysledek1 . " J</p>";
	} else{
		$vysledek = "Chyba";
	}
...
function polohovaEnergie(){
	...
	if ($cislo1 > 0 && $cislo2 > 0) {
		...
		$vysledek = "<p class='count'>m = " . $cislo1 . " " . $Jednotka1 . "g<br/>h = " . $cislo2 . " " . $Jednotka1 . "m<br/>E<sub>k</sub> = " . $vysledek1 . " " . $Jednotka1 . "J</p>";
	} else {
		$vysledek = "Chyba";
	}
...
function GravitacniSila(){
	...
	if ($cislo1 == 0 && $cislo2 > 0) {
		$cislo1 = $cislo2 * 10;
		$vysledek = "<p class='count'>Síla: " . $cislo1 . " N<br/>Hmotnost: " . $cislo2 . " kg</p>";
